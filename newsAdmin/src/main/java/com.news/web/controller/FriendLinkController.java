...
import com.news.web.service.WebFriendLinkService;
...
public class FriendLinkController {
	...
	public ModelAndView index() {
		ModelAndView mView = new ModelAndView("/web/friendLink/index");
	...
	public ModelAndView save() {
		ModelAndView mView = new ModelAndView("/web/friendLink/save");
