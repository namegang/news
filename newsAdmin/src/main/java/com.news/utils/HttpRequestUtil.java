...
public class HttpRequestUtil {
     ...
     * @return 
     */  
    public static String post(String url, Map<String, Object> params, int connectTimeout, int readTimeout, String charset){  
     ...
     * @return 
     */  
    public static String post(String url,  Map<String, Object> params, Map<String,String> headers, int connectTimeout, int readTimeout, String charset){  
     ...
     * @return 
     */  
    public static String get(String url,  Map<String, Object> params, int connectTimeout, int readTimeout, String charset){  
     ...
     * @return 
     */  
    public static String get(String url,  Map<String, Object> params, Map<String,String> headers,int connectTimeout, int readTimeout, String charset){  
     ...
     * @return 
     */  
    public static String put(String url,  Map<String, Object> params, Map<String,String> headers,int connectTimeout, int readTimeout, String charset){  
     ...
     * @return 
     */  
    public static String delete(String url,  Map<String, Object> params, Map<String,String> headers, int connectTimeout, int readTimeout, String charset){  
